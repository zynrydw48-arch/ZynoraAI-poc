; Zynora AI installer (formerly MemoryOS/NYXUS AI; Sprint 8). Wraps the existing
; frozen PyInstaller build (dist\ZynoraAI\, see memoryos.spec) in a per-user installer
...
#define MyAppPublisher "Zynora AI"
#define MyAppExeName "ZynoraAI.exe"
...
; equivalent of Program Files, e.g. %LOCALAPPDATA%\Programs\Zynora AI.
...
OutputBaseFilename=ZynoraAI-Setup-{#MyAppVersion}
...
[Files]
Source: "..\dist\ZynoraAI\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
// Zynora AI keeps its SQLite index/settings/search-history in
...
begin
  ...
  Response := MsgBox(
    'Also permanently delete your Zynora AI search history and file index database?' + #13#10 + #13#10 +
    'WARNING: this cannot be undone. If you plan to reinstall Zynora AI later, or are ' +
